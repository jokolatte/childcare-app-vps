...
SECRET_KEY = 'django-insecure-&y==7cm$7dm=+awdq^=o_4=l0waxme9&ko12#&^#2!vk2-zb)o'
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware',  # Ensure this is placed before CommonMiddleware
...
REST_FRAMEWORK = {
    'DEFAULT_RENDERER_CLASSES': [
        'rest_framework.renderers.JSONRenderer',  # Set JSON as the default renderer
    ],
